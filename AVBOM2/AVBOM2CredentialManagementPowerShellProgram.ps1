...
$strErrorNotificaitonEmailTo = "bomf@ford.com;braokott@ford.com;psatyan1@ford.com;RROSE66@ford.com"

# Used To Identify When To Send Team Password Expiration Email
$intDaysSendNotification = 15
...
$strSharePointSite = "https://it1.spt.ford.com/sites/GCE/CMT/"

# Share Point List Conneciton IDs
$strSharePointListName = "CredentialDetails"
$strSharePointViewID = "{C3E2E1BD-050F-45AC-B95A-1509D284AAAD}"

# Summary Email
$strRecieveEmailSummary = "Yes"
$strEmailSummaryRecipients = "dmorasa@ford.com;ASENGUP5@ford.com;cmirall1@ford.com;vkodali1@ford.com;braokott@ford.com;jnicdao@ford.com;akalayan@ford.com;bomf@ford.com;gpiot1@ford.com;vmoolaga@ford.com;ssurapa1@ford.com"
...
function SendOutlookEmail([String] $strMailTo, [String] $strMailSubject, [String] $strMailBody, [String] $strWasError){
    ...
    try{
        ...
        write-host "Process Did Not Complete Successfully" ($strCurrentDate.ToString("MM/dd/yyyy")) " - In Function: SendOutlookEmail, Error: " $_ $strAlosError
        exit
    }
    return $booReturn
}
